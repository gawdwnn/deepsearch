...
CREATE INDEX IF NOT EXISTS "session_user_id_idx" ON "ai-app-template_session" USING btree ("user_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "user_request_created_at_idx" ON "ai-app-template_user_request" USING btree ("created_at");